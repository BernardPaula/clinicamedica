...
public class Receitas implements Serializable{
	...
	public Receitas(Integer cd_receitas, Integer cd_paciente, Integer cd_medico, Date dt_receita,
			Integer cd_medicamento, String ds_posologica, Integer cd_exame, Integer cd_clinica, String ds_observacoes) {
		super();
		...
		this.ds_posologica = ds_posologica;
	...
	public String getDs_posologica() {
		return ds_posologica;
	}


	public void setDs_posologica(String ds_posologica) {
		this.ds_posologica = ds_posologica;
	}
